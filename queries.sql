...
DROP TABLE IF EXISTS ridershiprevenue CASCADE;
DROP TABLE IF EXISTS streetcardelay CASCADE;
DROP TABLE IF EXISTS busdelay CASCADE;
DROP TABLE IF EXISTS traindelay CASCADE;


\i schema.ddl
\COPY vehicle from Vehicle.csv with csv;
\COPY delay from Delay.csv with csv;
\COPY ridershiprevenue from RidershipRevenue.csv with csv;
\COPY streetcardelay from StreetcarDelay.csv with csv;
\COPY busdelay from BusDelay.csv with csv;
\COPY traindelay from trainDelay.csv with csv;
